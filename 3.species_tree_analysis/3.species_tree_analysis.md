...
#### 1. Generate consensus fasta per individual and chromosome (as described [here](2.call_variants_and_fasta_consensus/2.call_variants_and_fasta_consensus.md))
...
1. [ASTRAL](https://github.com/MafaldaSFerreira/hare-phylogenomics/blob/master/3.species_tree_analysis.md#astral);
2. [SVDquartets](https://github.com/MafaldaSFerreira/hare-phylogenomics/blob/master/3.species_tree_analysis.md#svdquartets);
3. [Maximum likelihood tree of a concatenated whole exome alignment (RAxML)](https://github.com/MafaldaSFerreira/hare-phylogenomics/blob/master/3.species_tree_analysis.md#concatenated-whole-exome-alignment).
...
Then run SVDquartets using [PAUP](http://abacus.gene.ucl.ac.uk/software/paml.html):
...
Again using a folder per chromosome, get the consensus fasta alignments from [step 1](https://github.com/MafaldaSFerreira/hare-phylogenomics/blob/master/3.species_tree_analysis.md#1-generate-consensus-fasta-per-individual-and-chromosome-as-described-here). 
